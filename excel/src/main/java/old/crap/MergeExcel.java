...
public class MergeExcel {
    public static void main(String args[]) throws Exception {
        ...
        Workbook workBook1 = mergeExcel.checkFileFormat("/home/tsv/temp/test-xlsx/Вінниця.xls");
        Workbook workBook2 = mergeExcel.checkFileFormat("/home/tsv/temp/test-xlsx/Волинь.xls");
//        Workbook workBook2 = mergeExcel.checkFileFormat("second excel");
//        String result = "result excel";
        String result = "/home/tsv/temp/test-result/res.xlsx";
        ...
        mergeExcel.writeToFile(result, totalList, firstRowList1);
    ...
    public ArrayList<ArrayListRows> sortColoumns(ArrayList<ArrayListRows> rowsList, ArrayList<Integer> tot) {
        ArrayList<ArrayListRows> rowsArrayList = new ArrayList<>();
